...
export default function Home() {
  const spots = [
    ...
    { name: 'Sakura sushi', barrio: 'San Antonio', tipo: 'Gastronomía Japonesa', nota: 'Jueves de 2x1 en todos los rollos de sushi', image: '/images/spots/sakura.jpg' },
  ...
  return (
    <section>
      ...
      <p className="small">El mejor lugar para encontrar los rincones mas deliciosos y sorpendentes de la Ciudad.</p>
